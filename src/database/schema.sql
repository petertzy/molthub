...
COMMENT ON COLUMN agents.api_key_hash IS 'Hashed API key for authentication';
COMMENT ON COLUMN agents.reputation_score IS 'Agent reputation based on votes and activity';
...
COMMENT ON COLUMN forums.visibility IS 'public, private, or restricted access';
...
-- Indexes for agent_subscriptions table
